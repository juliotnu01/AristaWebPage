...
(function($) {
  ...
  NEXUS.isLTR = {
	...
	// Two Items Carousel
	if ($('.home1-team-slider, .home2-news-slider').length) {
		$('.home1-team-slider, .home2-news-slider').owlCarousel({
			rtl: NEXUS.isRTL.check(),
			autoplay:true,
			loop: true,
			margin: 15,
	...
	// Two Items Carousel
	if ($('.home7-team-slider').length) {
		$('.home7-team-slider').owlCarousel({
			rtl: NEXUS.isRTL.check(),
			autoplay:true,
			loop: true,
			margin: 30,
	...
	// Service Carousel
	if ($('.home5-testimonial-slider').length) {
		$('.home5-testimonial-slider').owlCarousel({
			rtl: NEXUS.isRTL.check(),
			loop: true,
			margin: 30,
			nav: true,
	...
	// Project Carousel
	if ($('.home3-project-slider').length) {
		$('.home3-project-slider').owlCarousel({
			rtl: NEXUS.isRTL.check(),
			loop: true,
			margin: 30,
			nav: false,
	...
	// Project Carousel
	if ($('.home4-project-slider').length) {
		$('.home4-project-slider').owlCarousel({
			rtl: NEXUS.isRTL.check(),
			loop: true,
			margin: 30,
			nav: true,
	...
	// Project Carousel
	if ($('.home5-team-slider').length) {
		$('.home5-team-slider').owlCarousel({
			rtl: NEXUS.isRTL.check(),
			loop: true,
			margin: 30,
			nav: true,
