                        ...
                        <div class="footer-widget about-widget">
                            ...
                            <ul class="list-style-two">
                                <li><a href="tel:+1234567890"><i class="fa-regular fa-phone-volume fa-fw"></i>
                                        +012-345-6789</a></li>
                                <li><a href="#"><i class="fal fa-envelope"></i> <span
                                            class="__cf_email__">info@nexus.com</span></a></li>
                            </ul>
                    ...
                    <div class="footer-column col-sm-6 col-lg-3">
                        <div class="footer-widget about-widget">
                            ...
                            <ul class="user-links">
                                ...
                                <li><a href="#">IT Infrastructure Installation</a></li>
                                <li><a href="#">Networking and Communication</a></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="widget-content">
                                    ...
                                    <ul class="post-right">
                                        ...
                                        <li class="title-holder">
                                            <h6 class="entry-title">
                                                <a href>How To Address Issues in Your IT System</a>
                                            </h6>
                                        </li>
                                    </ul>
                                </div>
                                <div class="post-item">
                                    ...
                                    <ul class="post-right">
                                        ...
                                        <li class="title-holder">
                                            <h6 class="entry-title">
                                                <a href>Enhance Your IT Infrastructure for Sustainability</a>
                                            </h6>
                                        </li>
                                    </ul>
                                </div>
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="inner-container">
                    <div class="copyright-text">&copy; Copyright 2024 by <a href="index.html">Nexus</a></div>
                </div>
            </div>
        </div>
    </footer>
